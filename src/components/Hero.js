...
const Hero = () => {
  return (
    <Zoom cascade>
      <div className="container flex flex-col-reverse items-center justify-center w-screen h-screen mx-auto mb-8 text-black-1 md:flex-row md:mb-0">
        ...
        <div className="absolute bottom-0 w-full origin-bottom scale-y-[.25] -z-10"></div>
      </div>
    </Zoom>
  );
};
